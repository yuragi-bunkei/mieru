...
- 嵌合: 軸⌀7.85（608内径8.000対策）、ブッシュ穴12.6（PETG摺動0.35/側）、
  ...
  ブッシュに偏心方向マーク
- こて実測反映: YIHUA 928D-III、最太部⌀22.0、直胴47.5、ボタンまで5mm。ボア⌀22.6、
  リング高40、M3×20＋インサート締結（座繰り6.5×4 / バカ穴3.4）

残り:
1. **前方プラスチック部の直径を実測**して `P.ironFrontDiameter` に入れる（ゴム部22.0より
   細ければ段付きボアになる。差が0.5mm未満なら不要）
2. **実印刷での嵌合検証**: 軸穴8.3・ブッシュ穴12.6・ボア22.6・水平穴4.7・柱ポケット40.6×30.6。
